...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Laravel-Proxy, surf the web secure and fast!</title>
		<meta content="index" name="robots" />
		<meta name="keywords" content="proxy, laravel-proxy, phproxy, nodeproxy, nodeUnblocker"/>
		<meta name="description" content="laravel-proxy is a site that allow you to surf the web secure and fast."/>
	<style>
...
@keyframes glow {
    ...
    <body>
        <section class="webdesigntuts-workshop">
            <form class="UrlForm" method="post" action="{{ secure_url('inputURL') }}">
                {{ Form::url('url',null,array('placeholder'=>"Type url you want to surf")) }}  	
		        <button>Surf</button>
            </form>
        </section>
    </body>
